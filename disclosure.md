...
Symantec asked for more time to release an advisory, because of their dependency on a component from a 3rd party vendor. Initially, they asked from me to **extend the 90 days disclosure deadline** until **June 2018** (i remind that the **initial report was on November**). oun
